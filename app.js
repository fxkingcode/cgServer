...
// const usersRouter = require('./routes/users');//유저 정보 보기,수정,프로필
// const gameRouter = require('./routes/game');//게임

// const login = require('./routes/login.js')(app, User);
// const signup = require('./routes/signup.js')(app, User);
// const writeforum = require('./routes/writeforum.js')(app, Forum);
// const modifyforum = require('./routes/modifyforum.js')(app, Forum);
// const writecomment = require('./routes/writecomment.js')(app, Comment);
// const writerecomment = require('./routes/writerecomment.js')(app, ReComment);
// const uploadprofile = require('./routes/uploadprofile.js')(app, User);
// const requestforums = require('./routes/requestforums.js')(app);
...
app.use(function(req, res, next) {
  ...
  if (resource.indexOf('/uploads/') == 0 || resource.indexOf('/forumImages/') == 0 || resource.indexOf('/comments/') == 0) {
...
//   });
//
//   socket.on('ForumRecommend', function(data) {
//     var RecommendSchema = new mongoose.Schema({Recommend_Email: String});
//     RecommendSchema.Recommend_Email = data.Email;
//
//     mongoose.model('forum').findOneAndUpdate({
//       idx: data.idx
//     }, {
//       $push: {
...
//   });
//
//   socket.on('CancelForumRecommend', function(data) {
//     var RecommendSchema = new mongoose.Schema({Recommend_Email: String});
//     RecommendSchema.Recommend_Email = data.Email;
//
//     mongoose.model('forum').findOneAndUpdate({
...
//     }, {
//       $pull: {
//         Recommend: { $elemMatch: { Recommend_Email: data.Email }}
//       }
//     })
//     .then((forum) => {
//       console.log("포럼 : " + forum);
...
//       "idx": -1
//     }).skip((page - 1) * 10).limit(10).exec(function(err, doc) {
//       if (err) {
//         console.log("에러 : " + err);
